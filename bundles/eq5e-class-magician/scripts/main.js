const MODULE_ID = "eq5e-class-magician";
...
const IMPORTS = [
    { rel: "data/magician-spells.json", pack: "world.eq5e-magician-spells", label: "EQ5e Magician Spells", key: (d)=>d?.flags?.eq5e?.spell?.spellId },
{ rel: "data/magician-aas.json", pack: "world.eq5e-aa", label: "EQ5e Alternate Abilities", key: (d)=>d?.flags?.eq5e?.aa?.aaId },
{ rel: "data/pet-equipment.json", pack: "world.eq5e-pet-equipment", label: "EQ5e Pet Equipment", key: (d)=>d?.name }
];
