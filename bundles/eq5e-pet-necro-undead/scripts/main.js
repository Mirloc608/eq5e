const MODULE_ID = "eq5e-pet-necro-undead";

const BASE = "systems/eq5e/bundles/eq5e-pet-necro-undead";
...
export async function generateNecroUndeadPacks() {
  const pets = await _fetchJSON(_modulePath(MOD, "data/necro-undead-pets.json"));
  const abilities = await _fetchJSON(_modulePath(MOD, "data/necro-undead-abilities.json"));
