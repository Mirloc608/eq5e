...
**Module ID:** `eq5e-class-necromancer`  
**Type:** class  
...
## Source spell definitions for derived classes
This module includes `data/necro-spells.json` as a **source-of-truth** list of Necromancer spell definitions.
Other modules (e.g., Shadowknight) can deterministically derive weaker variants from these definitions.
