// EQ5e Class: Wizard (class) - EQ5e content module
...
const MODULE_ID = "eq5e-class-wizard";

Hooks.once("init", () => {
  console.log(`[EQ5E] eq5e-class-wizard init`);
});

Hooks.once("ready", async () => {
  console.log(`[EQ5E] eq5e-class-wizard ready`);
