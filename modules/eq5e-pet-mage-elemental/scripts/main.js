// EQ5e Magician Pet: Elemental (pet) - EQ5e content module
...
Hooks.once("init", () => {
  console.log(`[EQ5E] eq5e-pet-mage-elemental init`);
});

Hooks.once("ready", async () => {
  console.log(`[EQ5E] eq5e-pet-mage-elemental ready`);
  ...
  game.eq5e.modules[MODULE_ID] = {
    version: "0.5.0-alpha",
    kind: "pet",
    title: "EQ5e Magician Pet: Elemental"
  };
});
