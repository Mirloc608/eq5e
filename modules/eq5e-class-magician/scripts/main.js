// EQ5e Class: Magician (class) - EQ5e content module
...
Hooks.once("init", () => {
  console.log(`[EQ5E] eq5e-class-magician init`);
});

Hooks.once("ready", async () => {
  console.log(`[EQ5E] eq5e-class-magician ready`);
